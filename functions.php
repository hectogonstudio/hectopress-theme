 ...
 */
function hectopress_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'hectopress_content_width', 640 );
}
add_action( 'after_setup_theme', 'hectopress_content_width', 0 );
 ...
 */
function hectopress_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hectopress' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'hectopress' ),
...
add_action( 'widgets_init', 'hectopress_widgets_init' );
...
function hectopress_scripts() {
	...
	wp_enqueue_script( 'hectopress-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'hectopress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
